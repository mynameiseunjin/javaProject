...
public class VarialeExample {
	...
	System.out.println("lingValue:" + longValue);
	...
	byte x = 10;
	byte y = 20;
	//byte result2 = x + y;  -> (위의 x,y과 타입이 맞지 않아 문법적으로 틀림. 
	int result2 = x + y;   //->위의 문장을 맞는 문법으로 작성 (아래도 동일)
	byte result3 = (byte)(x + y);
	System.out.println(result +","+result3);
	
	char charValue1 = 'A';   //A - 65라는 숫자
	char charValue2 = 1;
	...
	double resultVar1 = intVar1/4;  //결과 : 2.0   하지만 5는 사라짐
	//double resultVar1 = intVar1/4.0; -> 결과 : 10.0 / 4.0 -> 2.5
	System.out.println("10/4 결과 : " + (intVar1));
